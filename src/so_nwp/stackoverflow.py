...
def load_data(cache_dir=None):
  ...
  """
  filepath1 = os.path.join(cache_dir, 'stackoverflow_train.h5')
  filepath2 = os.path.join(cache_dir, 'stackoverflow_held_out.h5')
  filepath3 = os.path.join(cache_dir, 'stackoverflow_test.h5')
  if os.path.exists(filepath1) and os.path.exists(filepath2) and os.path.exists(filepath3):
      train_client_data = hdf5_client_data.HDF5ClientData(filepath1)
      held_out_client_data = hdf5_client_data.HDF5ClientData(filepath2)
      test_client_data = hdf5_client_data.HDF5ClientData(filepath3)
...
def load_word_counts(cache_dir=None):
  ...
  file_path = os.path.join(cache_dir, 'stackoverflow.word_count')
